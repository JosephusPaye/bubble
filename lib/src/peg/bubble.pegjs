...
Start
	= SpaceOrComment* nodes:Node* appearance:Appearance? {
...
NodeAppearance
	= selector:NodeSelector additionalSelectors:AdditionalNodeSelector* '{' SpaceOrComment* modifiers:NodeModifiers* '}' SpaceOrComment* {
...
String
  = '"' characters:StringCharacter* '"' {
    return { location: location(), value: characters.join('') };
  }
...
MultilineString
	= '[' characters:MultilineStringCharacter* ']' {
    return { location: location(), value: characters.join('') };
  }
